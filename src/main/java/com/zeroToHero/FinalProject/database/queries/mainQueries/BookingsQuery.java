...
public interface BookingsQuery {
    ...
    String getAllBookings =
        "SELECT booking_id, user_id, tours.title, bookings.created_at, bookings.start_date, bookings.end_date, bookings.price FROM bookings, tours WHERE bookings.tour_id = tours.tour_id;";
}
